          ...
          <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
              ...
              <View style={styles.center_part}>
                ...
                <TouchableOpacity onPress={() => { navigate('HVideoDetail', { v_info: video_info }) }}>
              ...
              <View style={{ flexDirection: 'row', paddingHorizontal: perfectSize(20) }}>
                <TouchableOpacity onPress={() => { navigate('HVideoReviewDetail', { avg_review: r_avg, review_count: r_count, reviews: reviews }) }}>
                  <Text style={styles.more_bt}>Read More</Text>
                </TouchableOpacity>
                {!user_reveiw_status &&
...
export default connect(mapStateToProps, mapDispatchToProps)(HomeVideoDetail);
