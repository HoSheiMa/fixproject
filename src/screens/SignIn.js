...
class SignInScreen extends Component {
  ...
  componentDidMount() {
    GoogleSignin.configure({
      ...
      webClientId:
        '869508202761-ff8droed1hm7m01tjuuqs0d7g01kil49.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
      ...
      .then(
        function(result) {
          if (result.user.emailVerified) {
            ...
            self.showAlert(
              'you need email verification. please check your email',
            );
          }
        }.bind(this),
      )
